...
void Configuration::writeConfiguration()
{
    ...
    configuration->setValue("themeStyle", settings.ui.themeStyle);
    configuration->endGroup();
...
void Configuration::readConfiguration()
{
    ...
    settings.ui.themeStyle = configuration->value("themeStyle", 0).toInt(); // Default to Auto
    configuration->endGroup();
...
void Configuration::setFlacCompressionLevel(int level)
{
    settings.capture.flacCompressionLevel = level;
}

int Configuration::getFlacCompressionLevel() const
{
    return settings.capture.flacCompressionLevel;
}

void Configuration::setFlacOutputFormat(int format)
{
    settings.capture.flacOutputFormat = format;
}
...
void Configuration::setThemeStyle(int style)
{
    settings.ui.themeStyle = style;
}

int Configuration::getThemeStyle() const
{
    return settings.ui.themeStyle;
}
